...
const EmojiPicker: ParentComponent<EmojiPickerProps> = ($props) => {
    ...
    return (<Modal
        ...
        <div class="emoji-picker-tabs">
            <Tab emoji='🕗' option={EmojiCategory[_recents]}/>
            <Tab emoji='🙂' option={EmojiCategory[_smileyAndEmotion]}/>
            <Tab emoji='🖐' option={EmojiCategory[_personAndBody]}/>
            <Tab emoji='🐱' option={EmojiCategory[_animalAndNature]}/>
            <Tab emoji='🍖' option={EmojiCategory[_foodAndDrink]}/>
            <Tab emoji='🌏' option={EmojiCategory[_travelAndPlaces]}/>
            ...
            <Tab emoji='✨' option={EmojiCategory[_activities]}/>
            <Tab emoji='💼' option={EmojiCategory[_objects]}/>
            <Tab emoji='⚠' option={EmojiCategory[_symbols]}/>
            <Tab emoji='🚩' option={EmojiCategory[_flags]}/>
        </div>
